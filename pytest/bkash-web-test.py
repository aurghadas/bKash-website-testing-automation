...
class TestBkashFlows:
    @pytest.fixture(autouse=True)
    def go_home(self, page: Page):
        page.goto(BASE)
        expect(page).to_have_url(BASE)

    def test_campaigns(self, page: Page) -> None:
    ...
    def test_blog(self, page: Page) -> None:
        #Minimize chat widget
    ...
    def test_bkash_app(self, page: Page) -> None:
        # Minimize chat widget
        min_btn = (
    ...
    def test_charge_calculator(self, page: Page) -> None:
        # Minimize chat widget
        minimize_chat(page)
    ...
    def test_customer_care(self, page: Page) -> None:
        # Minimize chat widget
        minimize_chat(page)
    ...
    def test_about(self, page: Page) -> None:
